...
import ArquitecturaSeguridad from "./modules/ArquitecturaSeguridad/ArquitecturaSeguridad";
  ...
  return (
    <div className="app-layout">
      ...
      <main className="app-content">
        ...
        {vistaActiva === "arquitectura" && (
          <>
            <div className="bloque-global">
              <ArquitecturaSeguridad />
            </div>
          </>
        )}
      </main>
