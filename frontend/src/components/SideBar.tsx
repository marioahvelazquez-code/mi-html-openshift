      ...
      <div id="accordion">
          ...
          {open.tableros && (
            <div className="list-group">
              <a className="list-group-item pl-4 p-1 d-block" href="#!">
                <small className="font-weight-bold">Solicitud estatal</small>
              </a>
              <a className="list-group-item pl-4 p-1 d-block" href="#!">
        ...
        <div className="card">
          ...
          {open.informes && (
            <div className="list-group">
              <a className="list-group-item pl-4 p-1 d-block" href="#!">
                <small className="font-weight-bold">Solicitudes estatales</small>
              </a>
              <a className="list-group-item pl-4 p-1 d-block" href="#!">
                <small className="font-weight-bold">Informes Analíticos</small>
              </a>
              <a className="list-group-item pl-4 p-1 d-block" href="#!">
                <small className="font-weight-bold">Solicitudes politicas</small>
              </a>
              <a className="list-group-item pl-4 p-1 d-block" href="#!">
